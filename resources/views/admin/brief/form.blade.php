...
@section('container')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Add New Brief</h4>
                    ...
                    @endif
                    <form action="{{route('brief.save')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        <div class="col-sm-6">
                                <strong><label for="horizontal-name-input" class="col-sm-3 col-form-label">Customer Name</label></strong>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="cus_name" id="horizontal-name-input" placeholder="Enter Customer Name here">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="cus_email" id="horizontal-name-input" placeholder="Enter Customer Email here">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="company_name" id="horizontal-name-input" placeholder="Enter Company Name here">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="company_slogan" id="horizontal-name-input" placeholder="Enter Company Slogan here">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select  class="form-control select2" name="logo_color" id="logo_color" multiple>
                                    <option class="as" selected disabled></option>
                                    <option class="ad"></option>
                                </select>
                            </div>
                            <div class="col-sm-12">
                                <strong><label for="horizontal-name-input" class="col-sm-3 col-form-label">Data</label></strong>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="data" id="horizontal-name-input" placeholder="Enter Data here">
                                    @if ($errors->has('data'))
