        ...
        <div class="row">
            ...
            <div class="col-md-3 d-flex align-items-center justify-content-center">
                ...
                <div class="contact-box">
                    <p>Call Any Time</p>
                    <a href="#" style="color: black;">{{ (!empty($brand_settings['company_number']->key_value) ? $brand_settings['company_number']->key_value : '') }}</a>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12 d-flex align-items-center">
                <div class="contact-mob">
                    ...
                    <div class="contact-box">
                        <p>Call Any Time</p>
                        <a href="#">{{ (!empty($brand_settings['company_number']->key_value) ? $brand_settings['company_number']->key_value : '') }}</a>
                    </div>
                    <i class="fa-solid fa-magnifying-glass"></i>
                </div>
            </div>
